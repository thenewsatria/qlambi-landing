...
const TestimoniCard = forwardRef((props: any, ref:any) => (
  <div className="bg-slate-100 rounded-3xl w-full md:w-2/3 2xl:w-[52rem] mr-8 2xl:mr-14 flex-[0_0_auto] px-4 py-4 md:p-8 lg:px-10 2xl:px-16 2xl:py-10" ref={ref}>
      <div className="mb-3 2xl:pb-4 2xl:pt-5 2xl:mb-5">
        ...
        <div className="mx-6 md:mx-10 py-3 2xl:mx-14 2xl:py-5 h-[6.5rem] md:h-[7.5rem] lg:h-[8.5rem] xl:h-[10rem]">
          <p className="text-xs md:text-sm lg:text-base 2xl:text-lg">
            {props.testimoni}
          </p>
        </div>
        <div className="w-full">
        ...
        <div className="ml-4 lg:ml-6 2xl:ml-8">
          {
            ...
            :
            <p className="font-semibold text-sm md:text-base 2xl:text-xl">{props.userName}</p>
          }
        </div>
      </div>
    </div>
